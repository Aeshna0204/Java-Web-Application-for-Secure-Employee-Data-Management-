...
public class EmployeeDAO implements EmployeeDAOInterface {
    ...
    public void add(EmployeeDTOInterface employeeDTO) throws DAOException {
        ...
        if (aadharCardNumber.length() == 0)
            throw new DAOException("length of AadharCard Number is 0");
    ...
    public void update(EmployeeDTOInterface employeeDTO) throws DAOException {
        ...
        if (employeeDTO == null)
            throw new DAOException("Employee in null");
        String employeeId = employeeDTO.getEmployeeId().trim();
        if (employeeId == null)
            throw new DAOException("EmployeeId is null");
        if (employeeId.length() == 0)
            throw new DAOException("Lenght of EmployeeId cannot be zero");
        String name = employeeDTO.getName();
        if (name == null)
            throw new DAOException("Name in null");
        name = name.trim();
        if (name.length() == 0)
            throw new DAOException("Length of name cannot be zero");
        int designationCode = employeeDTO.getDesignationCode();
        if (designationCode <= 0)
            throw new DAOException("Invalid Designation Code: " + designationCode);
        DesignationDAOInterface designationDAO = new DesignationDAO();
        ...
        if (basicSalary.signum() == -1)
            throw new DAOException("Basis Salary is Negative");
        String panNumber = employeeDTO.getPANNumber();
        if (panNumber == null)
            throw new DAOException("Pan Number is null");
        panNumber = panNumber.trim();
        if (panNumber.length() == 0)
            throw new DAOException("Length Pan Number is Zero");
        String aadharCardNumber = employeeDTO.getAadharCardNumber();
        if (aadharCardNumber == null)
            throw new DAOException("Aadhar Card Number is null");
        aadharCardNumber = aadharCardNumber.trim();
        if (aadharCardNumber.length() == 0)
            throw new DAOException("Length Aadhar Card Number is Zero");
        try {
            File file = new File(FILE_NAME);
            ...
            while (randomAccessFile.getFilePointer() < randomAccessFile.length()) {
                ...
                if (employeeIdFound && aadharCardNumberFound && panNumberFound)
                    break;
            }
            if (employeeIdFound == false) {
                randomAccessFile.close();
    ...
    public EmployeeDTOInterface getByEmployeeId(String employeeId) throws DAOException {
        ...
        if (employeeId.length() == 0)
            throw new DAOException("Invalid id zero length");
        try {
    ...
    public EmployeeDTOInterface getByPANNumber(String panNumber) throws DAOException {
        ...
        panNumber = panNumber.trim();
        if (panNumber.length() == 0)
            throw new DAOException("Length of PANNumber can not be Zero");
        try {
            File file = new File(FILE_NAME);
            if (file.exists() == false)
                throw new DAOException("Invalid PANNumber: " + panNumber);
    ...
    public EmployeeDTOInterface getByAadharCardNumber(String aadharCardNumber) throws DAOException {
        ...
        aadharCardNumber = aadharCardNumber.trim();
        if (aadharCardNumber.length() == 0)
            throw new DAOException("Length of Aadhar Card Number can not be Zero");
        try {
            File file = new File(FILE_NAME);
            if (file.exists() == false)
                throw new DAOException("Invalid Aadhar Card Number: " + aadharCardNumber);
